<div class="px-5 drawer-menu h-screen transition-all duration-500 delay-150 bg-blue-950 lg:block fixed top-0 z-[0] overflow-hidden whitespace-nowrap">

<div class="h-fit flex gap-3 items-center w-full text-center my-5">
    <img class="object-contain mx-auto w-2/3" height="50" width="80%" src="{{ '/img/BthFw.png' }}" />
</div>
@auth
