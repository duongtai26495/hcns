...
<ul class="flex flex-col taskbar-menu gap-5 items-center justify-start w-full mt-5">
    <li class="home-item {{ request()->is('dashboard*') ? 'active' : '' }} w-full whitespace-nowrap text-xs mx-auto cursor-pointer p-2 rounded-md">
        <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center"href="{{route('dashboard')}}"><svg class="w-full" width="100px" height="auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@if (auth()->user()->role->name === 'root' || auth()->user()->role->name === 'admin' || auth()->user()->role->name === 'moderator')
    <li class="employees-item {{ request()->is('user*') ? 'active' : '' }} w-full  mx-auto cursor-pointer p-2 rounded-md">
        <a class=" whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{route('user.list')}}">
    ...
    <li class="leave-item mx-auto cursor-pointer w-full  {{ request()->is('nghi-phep*') ? 'active' : '' }} p-2 rounded-md">
        <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{route('user.nghi-phep')}}">
        <svg class="w-full" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="salary-item mx-auto cursor-pointer {{ request()->is('bang-luong*') ? 'active' : '' }} w-full p-2 rounded-md">
        <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{route('bang-luong')}}">
        <svg class="w-full" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 17V17.5V18" stroke="#1C274C" stroke-width="1" stroke-linecap="round"/>
            <path d="M12 6V6.5V7" stroke="#1C274C" stroke-width="1" stroke-linecap="round"/>
            <path d="M15 9.5C15 8.11929 13.6569 7 12 7C10.3431 7 9 8.11929 9 9.5C9 10.8807 10.3431 12 12 12C13.6569 12 15 13.1193 15 14.5C15 15.8807 13.6569 17 12 17C10.3431 17 9 15.8807 9 14.5" stroke="#1C274C" stroke-width="1" stroke-linecap="round"/>
    ...
    <li class="news-item w-full {{ request()->is('tin-tuc*') ? 'active' : '' }} mx-auto cursor-pointer p-2 rounded-md">
        <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{route('tin-tuc')}}">
        <svg class="w-full" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="settings-item mx-auto w-full {{ request()->is('cai-dat*') ? 'active' : '' }}  cursor-pointer p-2 rounded-md">
        <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{route('cai-dat')}}">
        <svg class="w-full" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<button class="mx-auto py-4 mb-3 flex flex-col gap-2">
    <a class="whitespace-nowrap text-xs flex flex-col gap-1 items-center justify-center text-center" href="{{ route('logout') }}">
    <svg class="w-full" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
