...
<div class="max-w-3xl mt-5 p-2 lg:p-6 ">
    ...
    <h3 class="mb-5 text-2xl font-bold">Thông tin nhân viên</h3>
    <form id="createUserForm" action="{{ route('user.update') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="date" id="ngay_cap" name="ngay_cap"
                value="{{ old('ngay_cap', $user->ngay_cap) }}"
                class="mt-1 block w-full px-3 py-2 border @error('ngay_cap') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-300">
            @error('ngay_cap')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
...
<div class="mb-4">
    ...
    @enderror
        ...
        <div class="mb-4">
            ...
            <input type="date" id="ngay_chinh_thuc" name="ngay_chinh_thuc"
                value="{{ old('ngay_chinh_thuc', $user->ngay_chinh_thuc) }}"
                class="mt-1 block w-full px-3 py-2 border @error('ngay_chinh_thuc') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-300">
